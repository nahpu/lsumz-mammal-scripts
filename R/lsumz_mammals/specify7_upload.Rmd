...
At the higher level, we will split the part first, then the field within the part. We perform part splitting while cleaning column names. Whereas within part splitting is happened after we cleaned the column names.
